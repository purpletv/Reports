...
public class CategoryReportViewModel {
    ...
    public int getPtct_id() {
        return ptct_id;
    }
    public void setPtct_id(int ptct_id) {
    ...
    public CategoryReportViewModel(int ptct_id, String ptct_name, long total_sales, double total_amount, double total_gst,
	    long total_products) {
	super();
	this.ptct_id = ptct_id;
	this.ptct_name = ptct_name;
